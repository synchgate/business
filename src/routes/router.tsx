...
// POS
const PosDashboardPage = lazy(() => import("@/features/pos/pos-dashboard-page").then((m) => ({ default: m.PosDashboardPage })));
...
const SalesHistoryPage = lazy(() => import("@/features/pos/sales-history-page").then((m) => ({ default: m.SalesHistoryPage })));
        ...
        children: [
          {
            ...
            children: [
              ...
              { path: "/pos/dashboard", element: wrap(<PosDashboardPage />), handle: { title: "POS Dashboard" } },
              ...
              { path: "/pos/sales",     element: wrap(<SalesHistoryPage />), handle: { title: "Sales" } },
